...
- Public homepage, search, recent changes, wanted pages, category index/detail, media, auth, recovery, reset, verification, registration, article, backlinks, history, and the first discoverable diff route.
