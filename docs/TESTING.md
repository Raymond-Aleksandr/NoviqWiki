...
- Public homepage, search, recent changes, all pages, wanted pages, orphaned pages, dead-end pages, redirect maintenance, category index/detail, media, auth, recovery, reset, verification, registration, article, backlinks, history, and the first discoverable diff route.
