...
| Media     | Upload, validate, browse, insert syntax, references       | Playwright upload; media service validation/reference lookup; editor media-picker dialog audit                         |
| Admin     | Dashboard, settings, users, groups, roles                 | Playwright user creation; server-rendered admin sections; compact mobile user action feedback audit                    |
...
| Theme     | Design package colors and responsive layout               | CSS token inspection; desktop/mobile overflow checks; WebKit mobile sidebar/modal/button-state audit                   |
