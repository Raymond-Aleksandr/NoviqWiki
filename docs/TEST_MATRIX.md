...
| Theme     | Design package colors and responsive layout               | `pnpm test:ui`; light token/font audit; desktop/mobile overflow checks; WebKit sidebar/search-button/file/active-state  |
